      ...
      <div className="min-h-screen bg-gray-100">
        <div className="sidebar min-h-screen w-[3.35rem] overflow-hidden border-r hover:w-56 hover:bg-white hover:shadow-lg">
          <div className="flex h-screen flex-col justify-between pt-2 pb-6">
            <div>
              <div className="w-max p-2.5 border-b-2">
                <img src="vite.svg" className="w-8" alt="" />
              </div>
              <ul className="mt-6 space-y-2 tracking-wide">
                <li className="min-w-max ">
                  <a href="#" aria-label="dashboard" className="relative flex items-center space-x-4  px-4 py-3 hover:rounded-full hover:bg-slate-600 ">
                    <svg className="-ml-1 h-6 w-6 bg-blue-100 rounded-full " viewBox="0 0 24 24" fill="none">
